...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedFst* tracep) {
    ...
    tracep->pushPrefix("or_test", VerilatedTracePrefixType::SCOPE_MODULE);
    ...
    tracep->declBit(c+9,0,"y",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->popPrefix();
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+4,(vlSelfRef.or_test__DOT__a));
    bufp->fullBit(oldp+5,(vlSelfRef.or_test__DOT__b));
    bufp->fullBit(oldp+6,(vlSelfRef.or_test__DOT__y));
    bufp->fullBit(oldp+7,(vlSelfRef.or_test__DOT__or_gate__DOT__a));
    bufp->fullBit(oldp+8,(vlSelfRef.or_test__DOT__or_gate__DOT__b));
    bufp->fullBit(oldp+9,(vlSelfRef.or_test__DOT__or_gate__DOT__y));
}
