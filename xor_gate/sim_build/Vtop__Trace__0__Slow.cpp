...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedFst* tracep) {
    ...
    tracep->pushPrefix("xor_test", VerilatedTracePrefixType::SCOPE_MODULE);
    ...
    tracep->pushPrefix("xor_gate_DUT", VerilatedTracePrefixType::SCOPE_MODULE);
    ...
    tracep->declBit(c+9,0,"c",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->popPrefix();
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+4,(vlSelfRef.xor_test__DOT__a));
    bufp->fullBit(oldp+5,(vlSelfRef.xor_test__DOT__b));
    bufp->fullBit(oldp+6,(vlSelfRef.xor_test__DOT__c));
    bufp->fullBit(oldp+7,(vlSelfRef.xor_test__DOT__xor_gate_DUT__DOT__a));
    bufp->fullBit(oldp+8,(vlSelfRef.xor_test__DOT__xor_gate_DUT__DOT__b));
    bufp->fullBit(oldp+9,(vlSelfRef.xor_test__DOT__xor_gate_DUT__DOT__c));
}
